...
/** Calculates how much the employee should be paid
	...
	@return how much the employee should be paid based on their pay rate and days they worked
*/
double Professional::pay()
{
	double days;
...
/* Calculates how much money was allocated to the user's health insurance
	pre: none
	@return amount of money allocated to health insurance based on user's pay, days user 
		worked, and the percentage of paycheck that goes toward health insurance
*/
double Professional::healthIns()
{
